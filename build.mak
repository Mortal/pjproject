export PJDIR := /home/rav/work/pjproject
...
SDL_LDFLAGS = -L/usr/lib -pthread -lSDL2

# FFMPEG flags
FFMPEG_CFLAGS =  -DPJMEDIA_HAS_LIBAVDEVICE=1 -DPJMEDIA_HAS_LIBAVFORMAT=1 -DPJMEDIA_HAS_LIBAVCODEC=1 -DPJMEDIA_HAS_LIBSWSCALE=1 -DPJMEDIA_HAS_LIBAVUTIL=1  
...
export APP_LDLIBS := $(PJSUA_LIB_LDLIB) \
	...
	$(APP_THIRD_PARTY_EXT)\
	$(PJLIB_LDLIB) \
	-lbcg729 -lopus -lssl -lcrypto -lvpx -luuid -lm -lrt -lpthread  -lasound -L/usr/lib -pthread -lSDL2  -lavdevice -lavformat -lavcodec -lswscale -lavutil  -lv4l2 -lopencore-amrnb -lopencore-amrwb
...
export PJ_INSTALL_LDFLAGS_PRIVATE := $(APP_THIRD_PARTY_LIBS) $(APP_THIRD_PARTY_EXT) -lbcg729 -lopus -lssl -lcrypto -lvpx -luuid -lm -lrt -lpthread  -lasound -L/usr/lib -pthread -lSDL2  -lavdevice -lavformat -lavcodec -lswscale -lavutil  -lv4l2 -lopencore-amrnb -lopencore-amrwb
